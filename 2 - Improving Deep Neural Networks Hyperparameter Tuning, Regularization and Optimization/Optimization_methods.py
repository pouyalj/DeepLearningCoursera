...
def update_parameters_with_adam(parameters, grads, v, s, t, learning_rate = 0.01,
    ...
    for l in range(1, L + 1):
        ...
        # s["db" + str(l)] = ...
        # YOUR CODE STARTS HERE
        s["dW" + str(l)] = beta1 * s["dW" + str(l)] + (1 - beta2) * grads['dW' + str(l)] * grads['dW' + str(l)] 
        s["db" + str(l)] = beta1 * s["db" + str(l)] + (1 - beta2) * grads['db' + str(l)] * grads['db' + str(l)] 
        ...
        # parameters["b" + str(l)] = ...
        # YOUR CODE STARTS HERE
        parameters["W" + str(l)] = parameters["W" + str(l)] = parameters["W" + str(l)] - learning_rate * v_corrected["dW" + str(l)] / (np.sqrt(s_corrected["dW" + str(l)])+ epsilon)
        parameters["b" + str(l)] = parameters["b" + str(l)] = parameters["b" + str(l)] - learning_rate * v_corrected["db" + str(l)] / (np.sqrt(s_corrected["db" + str(l)])+ epsilon)
